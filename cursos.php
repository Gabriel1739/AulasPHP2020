<main role="main" class="container">
	...
	<div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
    	<div class="col-md-10 px-0">
            <h1 class="display-4 font-italic">Curso Completo + Brinde</h1>
	...
	<div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
    	<div class="col-md-10 px-0">
            <h1 class="display-4 font-italic">Curso de Video Aulas</h1>
            <p class="lead my-3">Este curso PRF é 100% focado no edital da PRF 2018, abordando todo o conteúdo que você precisa estudar para a prova.
	...
	<div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
    	<div class="col-md-10 px-0">
            <h1 class="display-4 font-italic">Curso de PDF</h1>
            <p class="lead my-3">Este curso PRF é 100% focado no edital da PRF 2018, abordando todo o conteúdo que você precisa estudar para a prova.
