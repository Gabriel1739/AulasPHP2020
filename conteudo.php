<main role="main" class="container">
  <div class="row">
    ...
    <div class="blog-post">
        ...
        <p>A Polícia Rodoviária Federal, sigla PRF, é um órgão policial ostensivo, organizado e mantido pela União, estruturado em carreira, subordinada ao Ministério da Justiça e Segurança Pública, que tem como principal função garantir a segurança nas rodovias federais e em áreas de interesse da União.</p>
        <p>As competências da PRF são definidas pela Constituição Federal no artigo 144, pela Lei nº 9.503/97 (Código de Trânsito Brasileiro), pelo Decreto nº 1.655, de 3 de outubro de 1995 e pelo seu regimento interno, aprovado pela Portaria Ministerial nº 219, de 27 de fevereiro de 2018.</p>
        <blockquote>
        <p>Sua estrutura conta com uma unidade administrativa central, situada em Brasília, e Unidades Administrativas Regionais, representadas por Superintendências. Além disso, é formada por Subunidades Administrativas e Unidades Operacionais (UOPs).</p>
        </blockquote>                       
      
      <center>
       <iframe width="550" height="310" src="https://www.youtube.com/embed/dYWgyd68OOc?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </center>
      ...
      <h1 class="pb-3 mb-4 font-italic border-bottom">
        ...
        <h3>Fiscalização de trânsito</h3>
          <center><img src="img/fisc.jpg" width="100%"></center>
                <p>
                  <hr>
        ...
        <h3>Atendimento de acidentes</h3> 
          <center><img src="img/atend.jpg" width="100%"></center>  
                <p>
                  <hr>
        ...
        <h3>Resgate emergencial e atendimento Pré-hospitalar</h3>        
          <center><img src="img/resg.jpg" width="100%"></center>  
                <p>
                  <hr>
        ...
        <h3>Operações Aéreas</h3>        
          <center><img src="img/opera.jpg" width="100%"></center>  
                <p>
                  <hr>
        ...
        <h3>Sistema SINAL</h3>        
          <center><img src="img/sinal.jpg" width="100%"></center>  
                <p>
                  <hr>
          ...
          <aside class="col-md-4 blog-sidebar">
            ...
            <div class="p-3">
              <h4 class="font-italic">Dados de 2020</h4>
              <ol class="list-unstyled mb-0">
                <li><a href="http://arquivos.prf.gov.br/arquivos/index.php/s/jdDLrQIf33xXSCe/download">Acidentes</a></li>
                <li><a href="http://arquivos.prf.gov.br/arquivos/index.php/s/3ljQBXiBlPtAB2M/download">Infrações de trânsito</a></li>
                <br>
                <h4 class="font-italic">Dados de 2019</h4>
                <li><a href="http://arquivos.prf.gov.br/arquivos/index.php/s/kRBUylqz6DyQznN/download">Acidentes</a></li>
                <li><a href="http://arquivos.prf.gov.br/arquivos/index.php/s/3ljQBXiBlPtAB2M/download">Infrações de trânsito</a></li>
              </ol>
            </div>
            ...
            <div class="p-3">
              ...
              <ol class="list-unstyled">
                <li><a href="https://github.com/Gabriel1739/AulasPHP2020" target="_blank">GitHub</a></li>
